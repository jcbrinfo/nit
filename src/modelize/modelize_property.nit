...
# Copyright 2014-2016 Lucas Bajolet <r4pass@hotmail.com>
# Copyright 2015-2016 Alexis Laferrière <alexis.laf@xymus.net>
...
redef class APropdef
	...
	do
		...
		else if mpropdef.is_intro and
				mpropdef.mproperty.visibility >= protected_visibility and
				mpropdef.name != "new" and
				mpropdef.name != "isa" then
...
redef class AMethPropdef
	...
	do
		...
		if atautoinit != null then
			...
			else if mclassdef.is_subset_def then
				modelbuilder.error(atautoinit, "Error: `autoinit` cannot be used in subsets.")
