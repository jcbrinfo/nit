...
class SeparateCompilerVisitor
	...
	do
		if not value.mtype.is_c_primitive then
			...
			var mtype = value.mtype.as_normal
			compiler.undead_types.add(mtype)
			self.require_declaration("class_{mtype.c_name}")
	...
	do
		var mcasttype = arguments.first.mcasttype
		if mcasttype.is_c_primitive then
			...
			mcasttype = mcasttype.to_c_primitive
			var res = self.monomorphic_send(mmethod, mcasttype, arguments)
	...
	do
		...
		var mtype1 = value1.mtype.as_normal
		var mtype2 = value2.mtype.as_normal
