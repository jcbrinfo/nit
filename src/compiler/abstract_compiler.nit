...
# Copyright 2012-2014 Alexandre Terrasa <alexandre@moz-code.org>
# Copyright 2013-2016 Lucas Bajolet <r4pass@hotmail.com>
# Copyright 2014-2016 Alexis Laferrière <alexis.laf@xymus.net>
# Copyright 2014      Johan Kayser <johan.kayser@viacesi.fr>
# Copyright 2016      Romain Chanoir <romain.chanoir@viacesi.fr>
...
abstract class AbstractCompilerVisitor
	...
	do
		...
		assert mtype.mnominal.mclass.name != "NativeArray"
...
redef class MClassType
	...
	do
		if mnominal.mclass.kind == extern_kind then
			return "void*"
		else
			return ctype
		end
...
redef class MModule
	# All `MProperty`s associated to all `MClassDef`s of `mclass` (including subsets)
