...
#
# Copyright 2012-2015 Jean Privat <jean@pryen.org>
# Copyright 2012      Alexandre Terrasa <alexandre@moz-code.org>
# Copyright 2014-2015 Lucas Bajolet <r4pass@hotmail.com>
...
do
	...
	for mprop in model.mproperties do
		...
		buf.append("<dd>{linkto(mprop.intro_mclassdef.mnominal)}</dd>\n")
	...
	for mprop in model.mproperties do
		for mpropdef in mprop.mpropdefs do
			...
			buf.append("<dt>class</dt>\n")
			buf.append("<dd>{linkto(mpropdef.mclassdef.mnominal)}</dd>\n")
