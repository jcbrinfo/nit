...
class RapidTypeAnalysis
	...
	do
		...
		if not add_class(mtype) then return
	...
	# return `true`.
	private fun add_class(mtype: MClassType): Bool
	do
	...
	# Add `mtype` (and its applicable subsets) to `live_types`.
	#
